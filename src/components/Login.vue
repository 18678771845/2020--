...
export default {
    ...
    methods: {
        verifyAccount() {
            if (this.account !== '18678771845') {
                this.accountError = '账号为手机号'
            } else {
                this.accountError = ''
            }
        },
        ...
        submit() {
            ...
            // if (this.account === '18663715411' && this.pwd === '123456') {
            //     this.isShowLoading = true
            //     // 登陆成功 设置用户信息
            //     localStorage.setItem('userImg', 'https://avatars3.githubusercontent.com/u/22117876?s=460&v=4')
            //     localStorage.setItem('userName', '小明')
